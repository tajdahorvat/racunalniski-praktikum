...
dosegljivost, \texttt{false}false pa zasedenost.
...
spremembi izmeri njegovo kakovsost. Tako moramo na vsakem koraku ugotavljati, katere
...
kakovost urnika:$$k_1 \cdot u_1 + k_2 \cdot u_2 + ... + k_n-1 \cdot u_n-1 + k_n \cdot u_n$$
